...
var Observable = function() {
  ...
  if (opts.sources) {
    ...
    ($__15 = this)._plugTo.apply($__15, $traceurRuntime.spread(this._sources));
  }
};
Observable.prototype = _.extend(Emitter.prototype, {
  ...
  _plug: function() {
    ...
    subs.forEach((function(sub) {
      var onNext = (function() {
        ...
        return ($__15 = sub).next.apply($__15, $traceurRuntime.spread(v));
      });
      var onEnd = (function() {
  ...
  next: function() {
    ...
    var $__6 = this;
    var v = ($__15 = vals).flatten.apply($__15, $traceurRuntime.spread(x));
    if (this.ended()) {
      return ;
    }
    this._later((function() {
      var $__16,
          $__17;
      if (!($__16 = $__6)._accept.apply($__16, $traceurRuntime.spread(v.args))) {
        return $__6;
      }
      $__6._state = ($__17 = $__6)._reduce.apply($__17, $traceurRuntime.spread([$__6._state], v.args));
      if ($__6._ready()) {
        $__6._last = $__6._extract($__6._state);
        $__6.emit(NEXT, $__6._last);
      }
      if ($__6._complete()) {
        $__6.end();
      }
  ...
  merge: function() {
    ...
    for (var os = [],
      ...
      os[$__13] = arguments[$__13];
    return ($__15 = this).combine.apply($__15, $traceurRuntime.spread([{endWhen: 'all'}], os));
  },
  zip: function() {
    for (var os = [],
